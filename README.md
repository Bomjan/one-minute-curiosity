...
| **06** | [The Bucket That Decides If You Get In](./episode-06-token-bucket-rate-limiter/) | [code.py](./episode-06-token-bucket-rate-limiter/code.py) · [code.js](./episode-06-token-bucket-rate-limiter/code.js) | [Explore](./episode-06-token-bucket-rate-limiter/explanation.md) |
