...
| **06** | [The Bouncer Who Hands Out Tickets (Token Bucket Rate Limiter)](./episode-06-token-bucket-rate-limiter/) | [code.py](./episode-06-token-bucket-rate-limiter/code.py) · [code.js](./episode-06-token-bucket-rate-limiter/code.js) | [Explore](./episode-06-token-bucket-rate-limiter/explanation.md) |
